...
export default function Footer({
  ...
  return (
    <div class="text-sm bg-[#251B0E]">
      <div class="flex flex-col relative">
        <div class="bg-detalhe-2 bg-repeat-x h-[11px] w-full absolute -top-[10px]"></div>
        {/* content */}
        <div class="bg-[#333333]">
          <div class="lg:container mx-auto md:max-w-6xl px-4 flex flex-col gap-6 justify-between lg:flex-row min-h-60 items-center">
        ...
        {/* copyright */}
        <div class="flex flex-col gap-4 items-center justify-between lg:flex-row lg:items-center py-2">
          <div class="lg:container mx-auto md:max-w-6xl px-4 text-white">
